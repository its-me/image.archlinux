...
RUN paru -Syu --noconfirm && \
    paru -S --noconfirm base-devel github-cli jq namcap openssh pacman-contrib rsync && \
    yes | paru -Scc
...
LABEL org.opencontainers.image.description="Extends the archlinux image with base-devel, github-cli, jq, namcap, openssh, pacman-contrib, and rsync for AUR package building"
